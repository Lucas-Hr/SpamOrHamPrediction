...
export default function Result({prediction, precisionHam, precisionSpam, setIsVisible}: ResultProps) {
  return (
    <div className="z-1000  absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white p-20 rounded-lg shadow-md border border-gray-200 py-8 ">
      ...
      >&times;</span>
      <h2 className="text-2xl font-semibold text-center">{prediction !== undefined ? prediction : "N/A"}</h2>
